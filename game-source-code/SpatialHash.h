...
class SpatialHash
{
    ...
    private:
        ...
        // Private functions:
        /** \brief Builds the map game_object_table_.
         ...
         * 	\param object a shared pointer of type IEntity taken by reference.
         ...
         * 	\param position is of type Position taken by reference.
         * 	\return unsigned int
         */
